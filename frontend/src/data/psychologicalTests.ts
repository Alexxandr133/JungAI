...
export const TEST_CATALOG = [
  ...
  },
  {
    ...
    description:
      '36 ситуационных дилемм по шести стадиям SD: дефицит, фиксация и интеграция.',
  ...
  },
  {
    ...
    description:
      'Спектр когнитивных функций (S, F, J, N, T, P) в экстравертной и интровертной полярности.',
