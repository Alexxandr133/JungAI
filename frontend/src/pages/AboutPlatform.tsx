  ...
  const sectionDocs = useMemo(() => {
    const mapByRole: Record<string, Record<SectionKey, { title: string; intro: string; items: SectionDocItem[] }>> = {
      ...
      researcher: {
        main: {
          title: 'Основное',
          intro: 'Исследовательский контур JungAI: агрегированные данные платформы, участники и аналитика.',
          items: [
            { title: 'Главная', description: 'Сводка метрик, быстрый доступ к инструментам и настраиваемые виджеты.', usage: 'Начинайте рабочий день с обзора данных и перехода к нужному разделу.', access: 'Исследователь, админ.' },
            { title: 'База снов', description: 'Каталог сновидений для поиска символов, паттернов и гипотез.', usage: 'Фильтруйте по источнику, ищите по тексту и символам.', access: 'Исследователь, админ.' },
            { title: 'Участники', description: 'Обезличенные профили клиентов с ценностями и раздражителями.', usage: 'Сегментируйте выборки без раскрытия персональных данных.', access: 'Исследователь, админ.' }
          ]
        },
        tools: {
          title: 'Инструменты',
          intro: 'Методологические и коммуникационные разделы платформы.',
          items: [
            { title: 'Амплификации', description: 'База символов, архетипов и интерпретационных связей.', usage: 'Формируйте словари и тематические выборки для исследований.', access: 'Исследователь, психолог, админ.' },
            { title: 'Библиотека материалов', description: 'Справочные документы и методические материалы.', usage: 'Храните и используйте источники в работе над публикациями.', access: 'Исследователь, психолог, админ.' },
            { title: 'Сообщения и календарь', description: 'Переписка и планирование встреч на платформе.', usage: 'Координируйте работу с коллегами без сторонних сервисов.', access: 'Исследователь, админ.' }
          ]
        },
        ai: {
          title: 'AI ассистент',
          intro: 'ИИ поддерживает формулирование гипотез и структурирование набора данных.',
          items: [
            { title: 'ИИ-чат исследователя', description: 'Диалог с контекстом снов платформы для аналитических выводов.', usage: 'Ускоряйте исследовательский цикл: гипотезы, интерпретации, структура текста.', access: 'Исследователь (после верификации), админ.' }
          ]
        },
        research: {
          title: 'Аналитика',
          intro: 'Виджеты дашборда и распределения по символам, тестам и категориям.',
          items: [
            { title: 'Виджеты дашборда', description: 'Настраиваемые карточки: сны, клиенты, сессии, частота символов.', usage: 'Добавляйте и переставляйте виджеты под свои исследовательские задачи.', access: 'Исследователь, админ.' }
          ]
        },
        publications: {
          title: 'Сообщества и публикации',
          intro: 'Публикация результатов, участие в сообществах и обмен с коллегами.',
          items: [
            { title: 'Публикации', description: 'Создание статей, черновиков и постов от имени сообщества.', usage: 'Оформляйте результаты исследований для профессиональной аудитории.', access: 'Исследователь, психолог, админ.' },
            { title: 'Лента', description: 'Общая лента постов с фильтрами по авторам и сообществам.', usage: 'Следите за работой коллег и находите материалы для цитирования.', access: 'Исследователь, психолог, админ.' }
          ]
        }
      }
    };
