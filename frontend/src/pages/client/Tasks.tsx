    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      >
        <header style={{ marginBottom: isDesktop ? 28 : isMobile ? 18 : 22 }}>
          ...
          >
            Здесь отображаются ваш уровень и баллы за активность: заходы, задания и другие действия на платформе. Раздел помогает отслеживать прогресс и смотреть, за что начисляются очки.
          </p>
        </header>
