...
const HANDBOOK_SECTIONS: HandbookSection[] = [
        ...
        body: [
          ...
          { type: 'h', text: 'Основное' },
          {
            ...
            items: [
              ...
              'Запросы — кто сам к вам постучался: принять, ответить или вежливо отказать.'
            ]
          },
          { type: 'h', text: 'Инструменты' },
          {
            ...
            items: [
              ...
              'Библиотека — книги и материалы под рукой, когда нужна опора. (в заработке)'
            ]
          },
          { type: 'h', text: 'AI, исследования, сообщество' },
          {
            type: 'ul',
            items: [
              'AI Ассистент — когда нужно набросать гипотезу, структуру сессии или расшифровать запись.',
              'Амплификации — библиотека символов: заглянуть, чтобы не держать всё в голове.',
          ...
          { type: 'h', text: 'Ещё рядом' },
          {
            type: 'ul',
            items: [
              'О платформе — короткий обзор платформы.',
    ...
    articles: [
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'path', to: '/chat', label: 'Открыть сообщения' }
        ]
      },
      {
        id: 'requests',
        title: 'Запросы клиентов',
        summary: 'Входящие заявки на консультацию или чат.',
        kind: 'guide',
        body: [
          {
            type: 'p',
            text: 'Сюда приходят заявки с контактами и описанием запроса. Статусы: новый, принят, отклонён.'
          },
          { type: 'h', text: 'Действия по заявке' },
          {
            type: 'ul',
            items: [
              '«Начать чат» — переписка по этой заявке.',
              '«Начать ведение клиента» — добавить человека в ваш список клиентов.',
              '«Отклонить» — указать причину; она уйдёт клиенту сообщением.'
            ]
          },
          { type: 'path', to: '/psychologist/requests', label: 'Открыть запросы' }
        ]
      }
    ]
  },
  {
    ...
    title: 'Инструменты',
    icon: 'hammer',
    description: 'Ведение кейса, сны, феномены и библиотека.',
    articles: [
      {
        id: 'work-area',
      ...
      },
      {
        id: 'materials',
        title: 'Библиотека',
        summary: 'Книги, статьи, лекции и видео для практики.',
        kind: 'material',
        body: [
          {
            type: 'p',
            text: 'Библиотека — база знаний: материалы сгруппированы по типам (книги, статьи/лекции, видео). Ищите по названию и тегам, открывайте карточку материала для чтения.'
          },
          {
            type: 'p',
            text: 'Используйте как персональную подборку под метод и конкретные кейсы; позже сюда же можно опираться из справочника и обучений.'
          },
          { type: 'path', to: '/materials', label: 'Открыть библиотеку' }
        ]
      }
    ]
  },
  ...
  {
    id: 'research',
    title: 'Исследования и сообщества',
    icon: 'microscope',
    description: 'Амплификации, публикации и общая лента.',
    articles: [
      {
        id: 'amplifications',
        title: 'Амплификации',
        summary: 'Сборник символов, архетипов и интерпретаций.',
        kind: 'material',
        body: [
          {
            type: 'p',
            text: 'Амплификации — методическая база: символ, заголовок, содержание, категория и теги. Используйте как опору при анализе снов и образов.'
          },
          {
            type: 'ul',
            items: [
              'Поиск по символу, названию и тексту.',
              'Фильтр по категориям.',
              '«+ Добавить амплификацию» — создание своей карточки (психолог/админ).',
              'Редактирование доступно автору записи или администратору.'
            ]
          },
    ...
    articles: [
      ...
      },
      {
        ...
        body: [
          {
            type: 'p',
            text: 'Страница «О платформе» — структурированное описание блоков JungAI с пояснениями «что это / как пользоваться / кому доступно». Полезно как краткая карта продукта рядом с этой wiki.'
          },
          { type: 'path', to: '/about', label: 'Открыть «О платформе»' }
        ]
      },
      {
        id: 'support',
