...
const HANDBOOK_SECTIONS: HandbookSection[] = [
  ...
  },
  {
    ...
    title: 'Сообщества',
    icon: 'book',
        description: 'Хаб постов, подписки и черновики.',
    articles: [
      {
        id: 'publications',
        title: 'Мои посты',
        summary: 'Ваши посты, сообщества и черновики в хабе.',
        kind: 'guide',
        body: [
          {
            type: 'p',
            text: 'Скоуп «Мои» в сообществах показывает ваши посты. Черновики и комментарии — в правой колонке, каталог сообществ — слева.'
          },
          {
            type: 'ul',
            items: [
          ...
          { type: 'path', to: '/communities', label: 'Открыть сообщества' }
        ]
      },
      {
        id: 'feed',
        title: 'Сообщества',
        summary: 'Хаб постов: все / подписки / мои, сообщества слева, черновики справа.',
        kind: 'guide',
        body: [
          {
            type: 'p',
            text: 'На широком экране: сообщества слева, лента постов в центре, черновики и комментарии справа.'
          },
          {
            type: 'ul',
            items: [
              'Скоупы Все / Подписки / Мои и сортировка.',
              'Фильтр типа поста.',
              'Клик по посту — полная страница и комментарии.'
            ]
          },
          { type: 'path', to: '/communities', label: 'Открыть сообщества' }
        ]
