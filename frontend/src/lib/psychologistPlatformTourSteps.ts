...
export const PSYCHOLOGIST_DASHBOARD_TOUR_STEPS: DriveStep[] = [
  ...
  },
  {
    ...
    popover: {
      ...
      description:
        'Рабочий стол (эта страница), Клиенты, Сессии (календарь встреч), Сообщения (чаты с клиентами) и Запросы (входящие заявки на консультацию). Это ежедневный контур работы с людьми.',
      side: 'bottom'
    }
  },
  {
    ...
    popover: {
      ...
      description:
        'Рабочая область (заметки и вкладки по клиенту), Журнал снов, Необъяснимое (синхронии/феномены) и Библиотека материалов. Здесь фиксируете кейс и наблюдения между сессиями.',
      side: 'bottom'
    }
  },
  {
  ...
  },
  {
    ...
    popover: {
      title: 'Исследования',
      description:
        'Амплификации — сборник символов, архетипов и интерпретаций для методической опоры в анализе.',
      side: 'bottom'
    }
  },
  {
  ...
  },
  {
    ...
    popover: {
      title: 'Техподдержка',
      description:
        'Если что-то сломалось или нужен доступ админа к рабочей области клиента — создайте запрос здесь. Справка по разделам также есть в пункте «О платформе».',
      side: 'bottom'
    }
  },
  {
...
export const PSYCHOLOGIST_REQUESTS_TOUR_STEPS: DriveStep[] = [
  {
    popover: {
      ...
      description:
        'Входящие заявки на чат или консультацию с контактами клиента. Отсюда можно принять человека в практику или вежливо отклонить.',
      side: 'over',
      align: 'center'
    }
  },
  {
    element: '[data-tour="requests-header"]',
    popover: {
      title: 'Заголовок раздела',
      description:
        'Все открытые и обработанные запросы собраны на одной странице. Статусы: новый, принят, отклонён.',
      side: 'bottom'
    }
  },
  {
    ...
    popover: {
      ...
      description:
        'Читайте описание и контакты. «Начать чат» — переписка по заявке; «Начать ведение клиента» — добавить в ваш список клиентов; «Отклонить» — с причиной, которая уйдёт клиенту.',
      side: 'top'
    }
  }
];
